...
inline complex<double> expm1 (const complex<double> &z)
{
  const double x = real (z),y = imag (z);
...
inline complex<double> log1p (const complex<double> &z)
{
  const double x = real (z),y = imag (z); 
...
inline complex<double> sigma_l_calc (const complex<double> &l,const complex<double> &eta)
{
...
inline complex<double> log_Cl_eta_calc (const complex<double> &l,const complex<double> &eta)
{
...
inline complex<double> log_cut_constant_AS_calc (const int omega,const complex<double> &l,const complex<double> &eta)
{
  const complex<double> Ieta(-imag (eta),real (eta));
...
inline complex<double> log_cut_constant_CFa_calc (const bool is_it_normalized,const int omega,const complex<double> &l,const complex<double> &eta)
{
  const complex<double> Ieta(-imag (eta),real (eta));
  const double l_int = rint (real (l)), Ieta_int = rint (real (Ieta));
...
inline complex<double> log_cut_constant_CFb_calc (const bool is_it_normalized,const int omega,const complex<double> &l,const complex<double> &eta)
{
  const complex<double> Ieta(-imag (eta),real (eta));
  const double l_int = rint (real (l)), Ieta_int = rint (real (Ieta));
  const complex<double> eps = omega*(l - l_int) + (Ieta - Ieta_int);
...
inline complex<double> sin_chi_calc (const complex<double> &l,const complex<double> &eta)
{
...
inline complex<double> exp_I_omega_chi_calc (const int omega,const complex<double> &l,const complex<double> &eta)
{
