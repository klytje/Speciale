...
Coulomb_wave_functions::Coulomb_wave_functions()
    : neg_int_omega_one (0),
      neg_int_omega_minus_one (0),
      log_Cl_eta (0),
      Cl_eta (0),
      sigma_l (0),
      cut_constant_CFa_plus (0),
      cut_constant_CFa_minus (0),
      cut_constant_CFb_plus (0),
      cut_constant_CFb_minus (0),
      log_cut_constant_CFa_plus (0),
      log_cut_constant_CFa_minus (0),
      log_cut_constant_CFb_plus (0),
      log_cut_constant_CFb_minus (0),
      log_cut_constant_AS_plus (0),
      log_cut_constant_AS_minus (0),
      exp_I_chi (0),
      exp_minus_I_chi (0),
      one_over_sin_chi (0),
      sym_constant_arg_neg (0),
      sym_constant_arg_pos (0), 
      log_sym_constant_arg_neg (0),
      log_sym_constant_arg_pos (0),
      turning_point (0),
      prec_first_order_expansion (0),
      is_H_dir_int_naive (0),
      cwf_real_ptr (0),
      cwf_real_l_plus_ptr (0),
      cwf_real_l_minus_ptr (0),
      cwf_real_eta_plus_ptr (0),
      cwf_real_eta_minus_ptr (0),
      cwf_minus_eta_ptr (0),
      cwf_lp_ptr (0),
      l (0),
      eta (0), 
...
Coulomb_wave_functions::Coulomb_wave_functions (const bool is_it_normalized_c,const complex<double> &l_c,const complex<double> &eta_c)
    : neg_int_omega_one ((rint (real (l_c + complex<double> (-imag (eta_c),real (eta_c)))) == l_c + complex<double> (-imag (eta_c),real (eta_c))) && 
      ...
      prec_first_order_expansion (0.1*sqrt_precision),
      is_H_dir_int_naive (false),
      cwf_real_ptr (0),
      cwf_real_l_plus_ptr (0),
      cwf_real_l_minus_ptr (0),
      cwf_real_eta_plus_ptr (0),
      ...
      is_it_normalized (is_it_normalized_c)
{
    ...
    ODE_ptr = new ODE_integration (l,2.0*eta);
...
{ 
  ...
  const ODE_integration &ODE = *ODE_ptr;
