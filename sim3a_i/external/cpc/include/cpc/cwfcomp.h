...
#include <string>
#include <complex>
#include "cpc/complex_functions.h"
...
inline complex<double> ODE_integration::extrapolation_in_zero (const unsigned int n,const complex<double> T[]) const
{  
...
inline complex<double> ODE_integration::F_r_u (const complex<double> &z,const complex<double> &u) const
{
...
inline void ODE_integration::integration_Henrici (const unsigned int m,const complex<double> &h,
					   const complex<double> &r0,const complex<double> &u0,const complex<double> &du0,
					   const complex<double> &r,complex<double> &u,complex<double> &du) const
{
...
inline void ODE_integration::operator() (const complex<double> &r0,const complex<double> &u0,const complex<double> &du0,
				  const complex<double> &r,complex<double> &u,complex<double> &du) const
{
