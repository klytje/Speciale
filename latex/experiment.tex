\section{Experiment}
The work presented here in this thesis is based on a series of measurements carried out by the \SI{5}{MeV} accelerator at Aarhus University in 2017. From these, specifically the measurements involving the \SI{17.76}{MeV} $0^+$ resonance of \ce{^12C} is of interest - see figure \ref{fig: experiment: energy levels} for an overview of the energies. Although this section is written from the perspective of the $0^+$ resonance, with some minor changes in the numbers, it is equally valid for any of the other measurements. 

\begin{figure}[h]
	\centering
	\includegraphics[width=.8\textwidth]{figures/energy_levels.eps}
	\caption{The energy levels of the three states we will be working with. }
	\label{fig: experiment: energy levels}
\end{figure}
