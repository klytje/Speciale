...
ghist2d(r,["thetaLab[0]","thetaLab[1]","thetaLab[2]"],["eLab[0]","eLab[1]","eLab[2]"],200,(xlim,ylim),fname)

#if "wU" in r.getColumnNames():
    #print("weighted?")
    #r.hist2d(["thetaLab[0]","thetaLab[1]","thetaLab[2]"],["eLab[0]","eLab[1]","eLab[2]"],bins=200,range=(xlim,ylim),weights=["wU*(0.22*f[0][0]+(1-0.22)*f[0][1]+2*sqrt(0.22*(1-0.22))*(f[0][2]*cos(2*3.1415*0.69)+f[0][3]*sin(2*3.1415*0.69)))"]*3)
#else:
    #r.hist2d(["thetaLab[0]","thetaLab[1]","thetaLab[2]"],["eLab[0]","eLab[1]","eLab[2]"],bins=200,range=(xlim,ylim))
