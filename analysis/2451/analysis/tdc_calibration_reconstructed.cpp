...
int main(int argc, char *argv[]) {
    ...
    vector<vector<int>> ft_peaks = {{65500, 65600}};
    vector<vector<int>> bt_peaks = {{65100, 65200}, {65380, 65460}, {65460, 65520}, {65520, 65600}};
    ...
    vector<double> ft_peak = {100, 65500, 65600};
    vector<double> bt_peak = {200, 65100, 65200};
