...
int main(int argc, char *argv[]) {
    ...
    vector<vector<int>> ft_peaks = {{65500, 65600}}; // I manually read these off my data (just run it without anything to see them)
    vector<vector<int>> bt_peaks = {{65100, 65180}, {65180, 65250}, {65380, 65460}, {65460, 65520}};
    ...
    vector<double> ft_peak = {100, 65500, 65600}; // the area where we expect the peak to be. this is to help the fitting algorithm
    vector<double> bt_peak = {200, 65100, 65300};
